with
    ...
    cleaned_contract as (
        select
            ...
            case
                when contract_type_from_title is not null then contract_type_from_title
                when contract_type_from_desc is not null then contract_type_from_desc
                else 'unknown'
            end as contract_type
        from joined
    )

select * from cleaned_contract