...
These scripts wrap the commands documented in [`data/docs/dev_flow.md`](../data/docs/dev_flow.md) and the service READMEs. That guide uses **team-b** as the worked example; if you are on another team, set your team's values in `data/.env` before running.
